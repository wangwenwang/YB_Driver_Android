...
public class SlidingTitleView extends RelativeLayout {
	...
	private TextView title,goods_managment;
...
//                btn_back.setAlpha(1.0f);
		...
		goods_managment= (TextView) findViewById(R.id.goods_managment);
	}
	...
	public TextView getGoods_managment(){
		iv_show_menu.setVisibility(GONE);
		goods_managment.setVisibility(VISIBLE);
		return goods_managment;
	}
