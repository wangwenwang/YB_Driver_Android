...
public class NotifyActivity extends BaseActivity implements AsyncHttpCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleView.setText("订单资讯");
//        }
        client = new OrderAsyncHttpClient(this, this);
        Map<String, String> params = new HashMap<>();
        params.put("strLicense", "");
        params.put("strNewsId", getIntent().getStringExtra("id"));
        client.sendRequest(Constants.URL.GetNewDetail, params, Tag_Detail);
    ...
    public void postSuccessMsg(String msg, String request_tag) {
        ...
        if (request_tag.equals(Tag_Detail)) {
            ...
            if (notifies.size() > 0) {
                ...
                tv_title.setText(notify.getITitle());
                tv_content.setText(notify.getIContent());
                tv_info.setText("请司机：" + notify.getDriverName() +"于"+notify.getDriverName()+ "\n自：" + notify.getIFrom() + "装载"+"订单:"+notify.getITitle()+"，送至：" + notify.getITo());
            }
        }
    }
}
